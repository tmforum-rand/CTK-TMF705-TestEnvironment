...
var pmCollection = require('./TMF705-TestEnvironment-v4.0.0.testkit.json');
...
function exportEnvironment(url) {
    ...
    envJson.values.forEach(element => {
        if (element.key == "Test_Environment") {
